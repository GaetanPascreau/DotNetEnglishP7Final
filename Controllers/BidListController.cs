...
namespace Dot.Net.WebApi.Controllers
{
    ...
    public class BidListController : Controller
    {
        ...
        public IActionResult GetAllBidLists()
        {
            ...
            _logger.LogInformation("User requested the list of BidList on {Date} at {Time} (UTC)", DateTime.UtcNow.ToString("dddd, MMMM d, yyyy", CultureInfo.InvariantCulture), DateTime.UtcNow.ToString("h:mm:ss tt", CultureInfo.InvariantCulture));
        ...
        {
            _logger.LogInformation("User requested the BidList with Id = {Id} on {Date} at {Time} (UTC)", id, DateTime.UtcNow.ToString("dddd, MMMM d, yyyy", CultureInfo.InvariantCulture), DateTime.UtcNow.ToString("h:mm:ss tt", CultureInfo.InvariantCulture));
        ...
        public IActionResult AddBidList([FromBody] BidListDTO bidListDTO)
        {
            ...
            _logger.LogInformation("User created a new BidList on {Date} at {Time} (UTC)", DateTime.UtcNow.ToString("dddd, MMMM d, yyyy", CultureInfo.InvariantCulture), DateTime.UtcNow.ToString("h:mm:ss tt", CultureInfo.InvariantCulture));
            return Ok(result.Result);
        }
        ...
        public IActionResult UpdateBidList(int id, [FromBody] BidListDTO bidListDTO)
        {
            ...
            _logger.LogInformation("User updated the BidList with Id = {Id} on {Date} at {Time} (UTC)", id, DateTime.UtcNow.ToString("dddd, MMMM d, yyyy", CultureInfo.InvariantCulture), DateTime.UtcNow.ToString("h:mm:ss tt", CultureInfo.InvariantCulture));
            return Ok(result.Result);
        }
        ...
        public IActionResult DeleteBidList(int id)
        {
            ...
            if (result.Result == null)
            {
                _logger.LogInformation("User requested to delete the BidList with Id = {Id} on {Date} at {Time} (UTC)", id, DateTime.UtcNow.ToString("dddd, MMMM d, yyyy", CultureInfo.InvariantCulture), DateTime.UtcNow.ToString("h:mm:ss tt", CultureInfo.InvariantCulture));
                _logger.LogError("No BidList with Id = {Id} was found. User was advised to enter a valid Id.", id);
                return NotFound("BidList not found. Please enter a valid Id.");
            }

            _logger.LogInformation("User deleted the BidList with Id = {Id} on {Date} at {Time} (UTC)", id, DateTime.UtcNow.ToString("dddd, MMMM d, yyyy", CultureInfo.InvariantCulture), DateTime.UtcNow.ToString("h:mm:ss tt", CultureInfo.InvariantCulture));
            return Ok(result.Result);
        }
    }
}