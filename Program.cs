...
namespace Dot.Net.WebApi
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Application Starting Up on {Date} at {Time}", DateTime.UtcNow.ToString("dddd, MMMM d, yyyy", CultureInfo.InvariantCulture), DateTime.UtcNow.ToString("h:mm:ss tt", CultureInfo.InvariantCulture));
